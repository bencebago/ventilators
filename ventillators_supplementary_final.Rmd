...
The YouGov was a closed survey. Initial contact with participants was made through the internet, and YouGov specifically targeted and recruited participants from its panelists. One important thing to note is that in Japan and Brazil, the sampling system is set up differently than in the US and France. In Japan and Brazil, respondents are sent generic invites and are sent into the first available survey.  Participants filled out an online survey that automatically captured their responses. The survey was entirely voluntary. The main part of the questionnaire was distributed over two pages: participants first responded to the "allocation" and later to the "re-allocation" questions (8 and 7 items per page, respectively). Within one page, items were presented in a randomized order. The demographic questions were presented on different screens. Participants were given the possibility to go back with a "Back" button and change their responses. There were no review step, once participants submitted their response, they could not change them. The survey required completeness, i.e., participants could not submit it without responding to every single question. All participants had a unique YouGov ID with which we defined unique visitors. The view rate (invited respondents that clicked on the survey link) was 59.03% in the US, 53.85% in France, and approximately 15-25% in Japan and Brazil. The completition rate (people who clicked on the link and finished it) was 91.43% in the US, 92.02% in France, 67.38% in Japan, 84.89% in Brazil. We did not record partial data and which point of the experiment participants quit, therefore, participation rate (visitors who agreed to participate but did not finish the survey) cannot be calculated. No Cookies were used, no duplicate entries were made possible since all respondents had a unique identifier. Once people filled in the survey, they were not able to log in and provide answer any more. Participants who did not finish the questionnaire could not submit their response and hence, their response was nor saved nor analysed. 


The MM was an open survey. Initial contact with participants was made through the internet, specifically, through the Moral Machine website (moralmachine.org). Participants were recruited through this website, but the survey was not advertised in any other way. The website is home for multiple surveys dealing with ethical decision making in AI systems (for example, ethical decision making of self-driving vehicules). The survey was completely voluntary. The survey was presented on one page, with all items. On the top of the page the consent form and then the "allocation" questions (8 items) in randomized order. After, the "re-allocation" items (7 items) in randomized order. The demographic questions were presented on the same screen. Participants could have changed their responses to all questions at any time, until they submitted their response. Participants could not review their responses afterwards. Browser fingerprints and cookies were used to idenitfy dublicates and define unique visitors. There were no completeness check, participants could have submitted their survey without answering all the questions. Data from these participants are also saved and are analysed. Over the survey period, 250 000 people visited the moralmachine.org website, out of which 9951 clicked and completed this survey. The accurate view rate cannot be calculated because we did not collect information on how much people simply clicked on the survey, data of those people who did not click on the "Submit" button at the end of the survey were not saved in any way. For the same reason, completition rate cannot be calculated either. Since all questions were on the same page, participation rate is not meaningful. Cookies and browser fingerprints were used to identify unique entries. Cookies were valid for ADD. IP addresses were only used to identify the country the participant is from. 
